...
export const ispratiPorakaSocket = (grupa, poraka, isprakjac, cb = null, korisnici=[], novRoom = false) => {
  console.log(grupa);
  if (socket) {
    socket.emit('newMessage', { poraka, grupa, isprakjac, korisnici, novRoom });
    cb({
      sodrzina: poraka,
      grupa, isprakjac
    });
